      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-black">Espace Élève</h1>
            <p className="mt-2 text-slate-500">
              Progresse dans tes apprentissages vers la réussite scolaire.
            </p>
          </div>
        ...
        <section className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-4 text-lg font-bold">Mon profil</h3>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="text-3xl">📚</div>
            <a href="/eleve/matieres"><h3 className="mt-4 text-lg font-bold">Mes matières</h3></a>
            <p className="mt-2 text-sm leading-6 text-slate-500">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="text-3xl">📊</div>
            <a href="/eleve/progression"><h3 className="mt-4 text-lg font-bold">Ma progression</h3></a>
            <p className="mt-2 text-sm leading-6 text-slate-500">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="text-3xl">🎯</div>
            <a href="/eleve/objectifs"><h3 className="mt-4 text-lg font-bold">Mes objectifs</h3></a>
            <p className="mt-2 text-sm leading-6 text-slate-500">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="text-3xl">📝</div>
            <h3 className="mt-4 text-lg font-bold">Mes révisions</h3>
            <p className="mt-2 text-sm leading-6 text-slate-500">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="text-3xl">💡</div>
            <h3 className="mt-4 text-lg font-bold">Exercices</h3>
            <p className="mt-2 text-sm leading-6 text-slate-500">
